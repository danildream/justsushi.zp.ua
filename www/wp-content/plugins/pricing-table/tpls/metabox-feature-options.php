...
<div style="width: 100%;float:left;margin-right: 25px;overflow: auto;">
 ...
 <table id="pricetable" class="draggable widefat" border="0" width="100%" cellspacing="0" cellpadding="0" >
   ...
   <tr class="nodrag nodrop">
       <td class="frow"><strong><span><?php _e('Features|Packages', 'wppt') ?></span></strong></td>  
...
?>
    ...
    foreach($feature_name as $index1=> $value1){
      ...
      <tr class="nodrag nodrop" style="cursor: default;">
      <td class="Detail">
        <strong><?php _e('Package Description', 'wppt'); ?></strong>   <input type="hidden" name="feature_name[Detail]" id="feature_name['Detail']" value="Detail">
      </td>
      </tr>
      <tr class="nodrag nodrop" style="cursor: default;">
      <td class="ButtonURL">
...
<td valign="top" class="apcl"><a style="float: right;" href="#"  class="add-package" id="addcolumn"><?php _e('Add Package', 'wppt'); ?></a></td>
</tr>
<tr><td class="afr"><a href="#" class="add-feature" id="addrow"><?php _e('Add Feature', 'wppt'); ?></a>  </td><td></td></tr>
</table><br/><br/>      
...
<script>   
    ...
    jQuery(function(){
      ...
      jQuery('#addcolumn').click(function(){
          ...
          if(trim(jQuery('#pricetable tbody tr:last td:first').html()) == "<?php _e('Features|Packages','wppt'); ?>"){
              alert("<?php _e('Create Features first','wppt'); ?>");
          }else{
              var package = prompt("<?php _e('Package Name:','wppt'); ?>");
              package = trim(package); 
              while(package.length == 0 ){
                   package = prompt("<?php _e('Package Name:','wppt'); ?>");
                   package = trim(package);    
              }
              ...
              jQuery("#pricetable").find("tr").each(function() {
               ...
               if(trim(jQuery(this).find('td:first').html()) != "<?php _e('Features|Packages','wppt'); ?>"){
